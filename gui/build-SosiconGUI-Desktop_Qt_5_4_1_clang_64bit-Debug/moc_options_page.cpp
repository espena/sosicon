/****************************************************************************
** Meta object code from reading C++ file 'options_page.h'
**
...
#include "../SosiconGUI/options_page.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'options_page.h' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_OptionsPage_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_OptionsPage_t qt_meta_stringdata_OptionsPage = {
    {
QT_MOC_LITERAL(0, 0, 11), // "OptionsPage"
QT_MOC_LITERAL(1, 12, 17), // "setOutputFilename"
QT_MOC_LITERAL(2, 30, 0) // ""

    },
    "OptionsPage\0setOutputFilename\0"
};
...
void OptionsPage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->setOutputFilename(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
